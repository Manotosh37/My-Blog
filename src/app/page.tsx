                ...
                <div className='container text-center'>
                    <div className='animate-fade-in-up max-w-4xl mx-auto'>
                        ...
                        <p className='text-xl md:text-2xl text-gray-400 mb-12 max-w-2xl mx-auto font-light leading-relaxed'>
                            Personal Stories and discoveries from my solo travel experience. Authentic stories, honet experience.
                        </p>
                        <div className='flex flex-col sm:flex-row gap-8 justify-center items-center'>
                            <Link href='/posts' className='elegent-button'>Read Stories</Link>
                            <Link href='/about' className='elegent-link text-lg'>About Me</Link>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className='container'>
                    <div className='text-center mb-16 animate-fade-in-up'>
                        ...
                        <p className='text-lg text-gray-400 max-w-2xl mx-auto font-light'>
                            Latest stories writter with love.
                        </p>
                    </div>
